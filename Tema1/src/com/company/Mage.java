...
public class Mage extends Character {
    public Mage(String name, int experience, int level) {
        ...
        this.inventory.maxWeight = 30;
        this.protectionEarth = true;
        this.strength = this.level * 5;
        this.charisma = this.level * 10;
        this.dexterity = this.level * 5;
    }

    public String toString() {
        return "Mage\tName:" + name + "\tExperience:" + experience + "\tLevel:" + level;
    }
    ...
    public void receiveDamage(int damage) {
        float chance = (strength + dexterity) / 10.f;
