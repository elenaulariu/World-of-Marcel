...
public class Rogue extends Character {
    public Rogue(String name, int experience, int level) {
        ...
        this.inventory.maxWeight = 20;
        this.protectionIce = true;
        this.strength = this.level * 5;
        this.charisma = this.level * 5;
        this.dexterity = this.level * 10;
    }
    ...
    public String toString() {
        return "Rogue\tName:" + name + "\tExperience:" + experience + "\tLevel:" + level;
    }
    ...
    public void receiveDamage(int damage) {
        float chance = (charisma + strength) / 10.f;
